...
from .views import UserEditView, profile, EditProfilePageView, CreateProfileView
...
urlpatterns = [
    ...
    path('<int:pk>/profile_edit/', EditProfilePageView.as_view(), name='profile_edit_page'),
